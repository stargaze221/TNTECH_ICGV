...
EMITTER_FLASHING_CONFIG_FILE_PATH = lu.get_path('vehicle_control_unit_py', 'config/sensors/realsense_emitter_flashing.yaml')
EMITTER_ON_CONFIG_FILE_PATH = lu.get_path('vehicle_control_unit_py', 'config/sensors/realsense_emitter_on.yaml')
